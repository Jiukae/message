    ...
    <div className="h-[100dvh] w-full bg-[#0c0e14] relative overflow-hidden flex items-center justify-center p-2.5 sm:p-6 text-white font-sans selection:bg-blue-500 selection:text-white">
      ...
      <div className="relative w-full max-w-md max-h-[calc(100dvh-1.25rem)] sm:max-h-[92vh] flex flex-col bg-[#121622]/90 border border-white/15 rounded-3xl shadow-2xl backdrop-blur-2xl overflow-hidden z-10 my-auto">
        ...
        <div className="shrink-0 pt-5 pb-3.5 px-6 text-center border-b border-white/10 bg-black/20 backdrop-blur-xl">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">ID Messenger</h1>
        ...
        {/* Content Body (Scrollable inside the card if screen height is constrained) */}
        <div className="flex-1 overflow-y-auto min-h-0 p-4 sm:p-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="영문 소문자/숫자 (예: choco_latte)"
          ...
          <div className="mt-6 pt-5 border-t border-white/10">
            <div className="flex items-center gap-1.5 text-xs text-white/50 mb-2.5">
              ...
              <span>체험용 빠른 로그인 (클릭 시 즉시 전환)</span>
            </div>
            <div className="grid grid-cols-2 gap-2">
              <button
                id="demo-user-jiuk-btn"
                type="button"
                onClick={() => handleQuickLogin('jiuk')}
                className="p-2.5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-400/40 rounded-2xl flex items-center gap-2 text-left transition-all group backdrop-blur-sm"
              >
                <div className="w-7 h-7 rounded-xl bg-gradient-to-tr from-blue-500 to-indigo-600 border border-white/15 flex items-center justify-center text-xs shadow-sm">
                  ⚡
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-semibold text-white group-hover:text-blue-300 truncate">지욱</div>
                  <div className="text-[10px] text-white/40 font-mono">@jiuk</div>
                </div>
              </button>

              <button
                id="demo-user-minseo-btn"
                type="button"
                onClick={() => handleQuickLogin('minseo')}
                className="p-2.5 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-pink-400/40 rounded-2xl flex items-center gap-2 text-left transition-all group backdrop-blur-sm"
              >
                <div className="w-7 h-7 rounded-xl bg-gradient-to-tr from-rose-400 to-pink-600 border border-white/15 flex items-center justify-center text-xs shadow-sm">
                  🌸
                </div>
                <div className="min-w-0">
                  <div className="text-xs font-semibold text-white group-hover:text-pink-300 truncate">민서</div>
                  <div className="text-[10px] text-white/40 font-mono">@minseo</div>
                </div>
              </button>
            </div>
          </div>
